...
## 📊 Structure des types de besoins
...
POST /besoins/delete/{id}  → Supprimer un besoin
```
...
**Note**: Ce CRUD fait partie d'un système plus large de gestion des dons pour le BNGRC. Il doit être complété par :
- CRUD des dons
- Système d'attribution des dons aux besoins
