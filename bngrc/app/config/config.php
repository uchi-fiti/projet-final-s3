...
return [
	...
	'database' => [
		// MySQL Example:
		 'host'     => '172.16.7.131',      // Database host (e.g., 'localhost', 'db.example.com')
		 'dbname'   => 'db_s2_ETU004171',   // Database name (e.g., 'flightphp')
		 'user'     => 'ETU004171',  // Database user (e.g., 'root')
		'password' => '4U0zvZH0',  // Database password (never commit real passwords)
