...
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (1, 2, 'Bâche', 15000.00, 200, 200, NULL, NULL, 1, '2026-02-15 00:00:01');

-- Ordre 2: Nosy Be, materiel, Tôle
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (4, 2, 'Tôle', 25000.00, 40, 40, NULL, NULL, 2, '2026-02-15 00:00:02');

-- Ordre 3: Mananjary, argent, Argent
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (2, 3, 'Argent', NULL, NULL, NULL, 6000000.00, 6000000.00, 3, '2026-02-15 00:00:03');

-- Ordre 4: Toamasina, nature, Eau (L)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (1, 1, 'Eau (L)', 1000.00, 1500, 1500, NULL, NULL, 4, '2026-02-15 00:00:04');

-- Ordre 5: Nosy Be, nature, Riz (kg)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (4, 1, 'Riz (kg)', 3000.00, 300, 300, NULL, NULL, 5, '2026-02-15 00:00:05');

-- Ordre 6: Mananjary, materiel, Tôle
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (2, 2, 'Tôle', 25000.00, 80, 80, NULL, NULL, 6, '2026-02-15 00:00:06');

-- Ordre 7: Nosy Be, argent, Argent
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (4, 3, 'Argent', NULL, NULL, NULL, 4000000.00, 4000000.00, 7, '2026-02-15 00:00:07');

-- Ordre 8: Farafangana, materiel, Bâche
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (3, 2, 'Bâche', 15000.00, 150, 150, NULL, NULL, 8, '2026-02-16 00:00:08');

-- Ordre 9: Mananjary, nature, Riz (kg)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (2, 1, 'Riz (kg)', 3000.00, 500, 500, NULL, NULL, 9, '2026-02-15 00:00:09');

-- Ordre 10: Farafangana, argent, Argent
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (3, 3, 'Argent', NULL, NULL, NULL, 8000000.00, 8000000.00, 10, '2026-02-16 00:00:10');

-- Ordre 11: Morondava, nature, Riz (kg)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (5, 1, 'Riz (kg)', 3000.00, 700, 700, NULL, NULL, 11, '2026-02-16 00:00:11');

-- Ordre 12: Toamasina, argent, Argent
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (1, 3, 'Argent', NULL, NULL, NULL, 12000000.00, 12000000.00, 12, '2026-02-16 00:00:12');

-- Ordre 13: Morondava, argent, Argent
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (5, 3, 'Argent', NULL, NULL, NULL, 10000000.00, 10000000.00, 13, '2026-02-16 00:00:13');

-- Ordre 14: Farafangana, nature, Eau (L)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (3, 1, 'Eau (L)', 1000.00, 1000, 1000, NULL, NULL, 14, '2026-02-15 00:00:14');

-- Ordre 15: Morondava, materiel, Bâche
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (5, 2, 'Bâche', 15000.00, 180, 180, NULL, NULL, 15, '2026-02-16 00:00:15');

-- Ordre 16: Toamasina, materiel, groupe
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (1, 2, 'Groupe électrogène', 6750000.00, 3, 3, NULL, NULL, 16, '2026-02-15 00:00:16');

-- Ordre 17: Toamasina, nature, Riz (kg)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (1, 1, 'Riz (kg)', 3000.00, 800, 800, NULL, NULL, 17, '2026-02-16 00:00:17');

-- Ordre 18: Nosy Be, nature, Haricots
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (4, 1, 'Haricots', 4000.00, 200, 200, NULL, NULL, 18, '2026-02-16 00:00:18');

-- Ordre 19: Mananjary, materiel, Clous (kg)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (2, 2, 'Clous (kg)', 8000.00, 60, 60, NULL, NULL, 19, '2026-02-16 00:00:19');

-- Ordre 20: Morondava, nature, Eau (L)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (5, 1, 'Eau (L)', 1000.00, 1200, 1200, NULL, NULL, 20, '2026-02-15 00:00:20');

-- Ordre 21: Farafangana, nature, Riz (kg)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (3, 1, 'Riz (kg)', 3000.00, 600, 600, NULL, NULL, 21, '2026-02-16 00:00:21');

-- Ordre 22: Morondava, materiel, Bois
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (5, 2, 'Bois', 10000.00, 150, 150, NULL, NULL, 22, '2026-02-15 00:00:22');

-- Ordre 23: Toamasina, materiel, Tôle
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (1, 2, 'Tôle', 25000.00, 120, 120, NULL, NULL, 23, '2026-02-16 00:00:23');

-- Ordre 24: Nosy Be, materiel, Clous (kg)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (4, 2, 'Clous (kg)', 8000.00, 30, 30, NULL, NULL, 24, '2026-02-16 00:00:24');

-- Ordre 25: Mananjary, nature, Huile (L)
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (2, 1, 'Huile (L)', 6000.00, 120, 120, NULL, NULL, 25, '2026-02-16 00:00:25');

-- Ordre 26: Farafangana, materiel, Bois
INSERT INTO bngrc_besoins (ville_id, type_id, description, prix_unitaire, quantite, quantite_restante, montant, montant_restant, ordre, date_saisie)
VALUES (3, 2, 'Bois', 10000.00, 100, 100, NULL, NULL, 26, '2026-02-15 00:00:26');
